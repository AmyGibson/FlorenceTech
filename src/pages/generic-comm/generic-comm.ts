...
/**
 * Generated class for the GenericCommPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-generic-comm',
  templateUrl: 'generic-comm.html',
})
export class GenericCommPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public http: Http,  
    ...
    private alertCtrl: AlertController, private log:LoggerProvider) {
      ...
      if (this.requestType == 'starters'){
        this.title = "Topics and starters"; 
      }else if (this.requestType == 'specialInterests'){
        this.title = "Special interests"; 
      }else if (this.requestType == 'avoid'){
        this.title = "Topics to avoid"; 
      }else if (this.requestType == 'general'){
        this.title = "General communication tips"; 
      }else if (this.requestType == 'worries'){
        this.title = "Common worries"; 
      }
  }
  ...
  ionViewDidLoad() {
    if (isNaN(this.globalVar.userID)){
      ...
      this.log.logActivity('general communication tips');
      this.getData();
    }
  }
